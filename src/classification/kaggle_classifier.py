...
from src.comment_analysis.parsing_utils import tokenizer
...
def kaggle_classify(stemming=True, rem_kws=True):
    ...
    features_train = get_features(set=train_set, stemming=stemming, rem_kws=rem_kws)
    ...
    features_train = dt_matrix_train
